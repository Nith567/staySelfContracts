...
async function main() {
  ...
  // Identity Verification Hub address (use staging for testing)
  ...
  // Payment token (USDC on Celo Alfajores)
  const token = "0x96CFA0E76Bd15d99A1230CA3955be5E677B746a6";
  
  // Bed prices in USDC (6 decimals)
  const boysBedPrice = 1000000n; // 1 USDC
  const girlsBedPrice = 1200000n; // 1.2 USDC
